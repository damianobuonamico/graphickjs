...
public:
  ...
  std::vector<float> triangulation_params(const RenderingOptions& options) const;
...
private:
  ...
  inline std::vector<float> linear_triangulation_params(const RenderingOptions& options) const { return { 0.0f, 1.0f }; }
  std::vector<float> quadratic_triangulation_params(const vec2& B, const RenderingOptions& options) const;
  std::vector<float> cubic_triangulation_params(const RenderingOptions& options) const;
  ...
  void linear_render(const RenderingOptions& options) const;
  void cubic_render(const RenderingOptions& options) const;
private:
