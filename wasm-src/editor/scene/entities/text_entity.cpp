...
void TextEntity::render(const RenderingOptions& options) const {
  ...
  // Renderer::push_frame_buffer({ 1000.0f, 600.0f });
  // Renderer::draw(m_text.geometry());
  // Renderer::pop_frame_buffer();
