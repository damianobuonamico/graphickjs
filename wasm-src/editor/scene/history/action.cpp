...
void Action::execute_add(Scene* scene) const
{
  ...
  //   scene->add(entity_id, m_data);
  //   bounding_rect =
  //       scene->get_entity(entity_id).get_component<TransformComponent>().approx_bounding_rect();
  //   // console::log("add entity");
  // } else {
  //   Entity entity = scene->get_entity(entity_id);
  //   rect bounding_rect_before =
  //   entity.get_component<TransformComponent>().approx_bounding_rect(); entity.add(m_data); rect
  //   bounding_rect_after = entity.get_component<TransformComponent>().approx_bounding_rect();
  //   // console::log("add component");
  //   bounding_rect = rect{math::min(bounding_rect_before.min, bounding_rect_after.min),
...
void Action::execute_remove(Scene* scene) const
{
  ...
  //   Entity entity = scene->get_entity(entity_id);
  //   rect bounding_rect_before =
  //   entity.get_component<TransformComponent>().approx_bounding_rect(); entity.remove(m_data);
  //   rect bounding_rect_after =
  //   entity.get_component<TransformComponent>().approx_bounding_rect();
...
void Action::execute_modify(Scene* scene) const
{
  ...
  // rect bounding_rect = rect{math::min(bounding_rect_before.min, bounding_rect_after.min),
  //                           math::max(bounding_rect_before.max, bounding_rect_after.max)};
