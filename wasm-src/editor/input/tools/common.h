...
namespace graphick::editor::input {
   ...
   * @param translate_in_first Whether to translate the incoming handle first, and in case calculate the outgoing handle accordingly, default is false.
   ...
   */
  size_t translate_control_point(PathComponent& path, const size_t point_index, const mat2x3& transform, const vec2* override_movement = nullptr, bool create_handles = false, bool keep_in_handle_length = true, bool translate_in_first = false, int* direction = nullptr);
