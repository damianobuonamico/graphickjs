...
namespace graphick::editor::input {
   ...
   *
   * The DirectSelectTool is a multi-purpose tool that allows the user to select and manipulate entities and their components (i.e. paths).
   * The state of the direct select tool is managed internally.
   *
  ...
  private:
    ...
    bool m_should_evaluate_selection = false;          /* Whether the selection should be evaluated (i.e. select the entity under the pointer). */
