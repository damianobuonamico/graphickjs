...
double RendererSettings::stroking_tolerance = 0.0001;
double RendererSettings::culling_threshold = 18.0;
...
vec4 RendererSettings::ui_primary_transparent = vec4(0.22f, 0.76f, 0.95f, 0.25f);
