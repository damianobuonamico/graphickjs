/**
 * @file renderer/renderer_cache.cpp
...
void RendererCache::set_grid_rect(const rect grid_rect, const ivec2 subdivisions)
{
...
void RendererCache::invalidate_rect(const rect invalidated_rect)
{
