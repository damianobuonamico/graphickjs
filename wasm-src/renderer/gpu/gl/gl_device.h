...
namespace Graphick::Render::GPU::GL {
  ...
  public:
    ...
    void upload_to_texture(const GLTexture& texture, const Box& rect, const void* data) const;
    ...
    void draw_arrays(const uint32_t index_count, const GLRenderState& render_state) const;
    void draw_elements(const uint32_t index_count, const GLRenderState& render_state) const;
    void draw_elements_instanced(const uint32_t index_count, const uint32_t instance_count, const GLRenderState& render_state) const;
  private:
