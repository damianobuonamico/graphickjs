                                 ...
                                 const Buffer& vertex_buffer)
{
  ...
  VertexAttribute instance_from_attr = Device::get_vertex_attribute(program.program,
                                                                    "a_instance_from");
  VertexAttribute instance_to_attr = Device::get_vertex_attribute(program.program,
                                                                  "a_instance_to");
  VertexAttribute instance_width_attr = Device::get_vertex_attribute(program.program,
                                                                     "a_instance_width");
  ...
  VertexAttrDescriptor instance_width_desc = {
      VertexAttrClass::Float, VertexAttrType::F32, 1, 24, 16, 1, 1};
                                 ...
                                 const Buffer& vertex_buffer)
{
  ...
  VertexAttribute instance_position_attr = Device::get_vertex_attribute(program.program,
                                                                        "a_instance_position");
  VertexAttribute instance_size_attr = Device::get_vertex_attribute(program.program,
                                                                    "a_instance_size");
  VertexAttribute instance_color_attr = Device::get_vertex_attribute(program.program,
                                                                     "a_instance_color");
  ...
  VertexAttrDescriptor instance_position_desc = {
      VertexAttrClass::Float, VertexAttrType::F32, 2, 20, 0, 1, 1};
  VertexAttrDescriptor instance_size_desc = {
      VertexAttrClass::Float, VertexAttrType::F32, 2, 20, 8, 1, 1};
  VertexAttrDescriptor instance_color_desc = {
      VertexAttrClass::Int, VertexAttrType::U8, 4, 20, 16, 1, 1};
                                     ...
                                     const Buffer& vertex_buffer)
{
  ...
  VertexAttribute instance_position_attr = Device::get_vertex_attribute(program.program,
                                                                        "a_instance_position");
  VertexAttribute instance_radius_attr = Device::get_vertex_attribute(program.program,
                                                                      "a_instance_radius");
  VertexAttribute instance_color_attr = Device::get_vertex_attribute(program.program,
                                                                     "a_instance_color");
  ...
  VertexAttrDescriptor position_desc = {VertexAttrClass::Int, VertexAttrType::U8, 2, 2, 0, 0, 0};
  VertexAttrDescriptor instance_position_desc = {
      VertexAttrClass::Float, VertexAttrType::F32, 2, 16, 0, 1, 1};
  VertexAttrDescriptor instance_radius_desc = {
      VertexAttrClass::Float, VertexAttrType::F32, 1, 16, 8, 1, 1};
  VertexAttrDescriptor instance_color_desc = {
      VertexAttrClass::Int, VertexAttrType::U8, 4, 16, 12, 1, 1};
                                   ...
                                   const Buffer& vertex_buffer)
{
  ...
  VertexAttrDescriptor instance_position_desc = {
      VertexAttrClass::Float, VertexAttrType::F32, 2, 16, 0, 1, 1};
  VertexAttrDescriptor instance_size_desc = {
      VertexAttrClass::Float, VertexAttrType::F32, 2, 16, 8, 1, 1};
