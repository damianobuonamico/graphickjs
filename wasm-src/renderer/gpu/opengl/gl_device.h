...
public:
   ...
   */
  inline static size_t max_texture_image_units() { return static_cast<size_t>(s_device->m_max_texture_image_units); }
   ...
   */
  static GLTexturesUniform get_textures_uniform(GLProgram& program, const std::string& name, const size_t count);
...
private:
   ...
   */
  void set_texture_arrays(const GLProgram& program, const std::vector<TextureArrayBinding>& textures);
