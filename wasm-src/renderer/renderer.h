...
public:
   ...
   * @param color The color to use.
   */
  static void draw_line(const vec2 start, const vec2 end, const std::optional<vec4> color = std::nullopt);
private:
  struct PathDrawable {
...
private:
  ...
  GPU::Framebuffer m_framebuffer;                    // The framebuffer to render elements to, it is used for caching.
