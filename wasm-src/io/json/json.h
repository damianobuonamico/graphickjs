/**
 * @file io/json/json.h
 * @brief Contains the declaration of the JSON parser.
 */
...
/**
 * @brief The JSON class represents a JSON object.
 */
class JSON {
 public:
  enum class Class { Null, Object, Array, String, Float, Int, Bool };
  ...
  class JSONWrapper {
   public:
    ...
    {
      return m_object ? m_object->begin() : typename Container::iterator();
    }
    typename Container::iterator end()
    {
      return m_object ? m_object->end() : typename Container::iterator();
    }
  ...
  class JSONConstWrapper {
   public:
    ...
    typename Container::const_iterator begin() const
    {
      return m_object ? m_object->begin() : typename Container::const_iterator();
    }
    typename Container::const_iterator end() const
    {
      return m_object ? m_object->end() : typename Container::const_iterator();
    }
 ...
 public:
  ...
  /**
   * @brief Create a new JSON array object.
   */
  static JSON array()
  {
  ...
  static JSON object()
  {
    return std::move(make(JSON::Class::Object));
  }
  ...
  void append(T arg)
  {
    ...
    m_internal.m_list->emplace_back(arg);
  }
  ...
  template<typename T>
  typename std::enable_if<std::is_integral<T>::value && !std::is_same<T, bool>::value, JSON&>::type
  operator=(T i)
  {
    set_type(Class::Int);
    m_internal.m_int = i;
