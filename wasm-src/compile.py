...
files = []
options = ['ALLOW_MEMORY_GROWTH', 'EXPORT_ES6', 'MODULARIZE', 'MIN_WEBGL_VERSION=2', 'MAX_WEBGL_VERSION=2', 'USE_WEBGL2', 'FULL_ES3', 'NO_DISABLE_EXCEPTION_CATCHING', 'EXPORTED_RUNTIME_METHODS="["cwrap"]"']
