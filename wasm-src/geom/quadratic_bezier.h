...
struct QuadraticBezier {
  ...
  static constexpr QuadraticBezier<T> from_coefficients(const math::Vec2<T> a,
                                                        const math::Vec2<T> b,
                                                        const math::Vec2<T> c)
  {
  ...
  static constexpr QuadraticBezier<T> from_coefficients(
      const std::array<math::Vec2<T>, 3> &coefficients)
  {
    return QuadraticBezier<T>(coefficients[2],
