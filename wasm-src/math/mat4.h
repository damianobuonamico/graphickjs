...
struct Mat4 {
  ...
  constexpr Mat4()
      : value{Vec4<T>(1, 0, 0, 0), Vec4<T>(0, 1, 0, 0), Vec4<T>(0, 0, 1, 0), Vec4<T>(0, 0, 0, 1)}
  {
  }
  ...
  template<typename U>
  constexpr Mat4(const Mat4<U> &m)
      : value{Vec4<T>(m[0]), Vec4<T>(m[1]), Vec4<T>(m[2]), Vec4<T>(m[3])}
  {
  }
