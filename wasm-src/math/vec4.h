...
{
  return Vec4<T>(v.x + static_cast<T>(scalar),
...
{
  return Vec4<T>(static_cast<T>(scalar) + v.x,
...
constexpr Vec4<T> operator%(const Vec4<T> &v, U scalar)
{
  return Vec4<T>(static_cast<T>(static_cast<int>(v.x) % static_cast<int>(scalar)),
...
constexpr Vec4<T> operator%(U scalar, const Vec4<T> &v)
{
  return Vec4<T>(static_cast<T>(static_cast<int>(scalar) % static_cast<int>(v.x)),
...
constexpr Vec4<T> operator%(const Vec4<T> &v1, const Vec4<T> &v2)
{
  return Vec4<T>(static_cast<T>(static_cast<int>(v1.x) % static_cast<int>(v2.x)),
