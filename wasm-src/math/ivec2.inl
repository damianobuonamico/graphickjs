...
namespace std {
  ...
  inline ostream& operator<<(ostream& os, const Graphick::Math::ivec2 v) {
    os << "(" << v.x << ", " << v.y << ")";
    return os;
  }

  template <> class numeric_limits<Graphick::Math::ivec2> {
  public:
    static inline Graphick::Math::ivec2 min() { return Graphick::Math::ivec2{ numeric_limits<int>::min() }; }
    static inline Graphick::Math::ivec2 max() { return Graphick::Math::ivec2{ numeric_limits<int>::max() }; }
    static inline Graphick::Math::ivec2 lowest() { return Graphick::Math::ivec2{ numeric_limits<int>::lowest() }; }
  };
